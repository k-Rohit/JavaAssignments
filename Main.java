...
public class Main {
    public static void main(String[] args) {
        ...
        // Creating an object of the calculator class to use the various functions in it
        ...
        while (true){
            ...
            // Using switch case to give user the option to select any desired operation.
            switch (option) {
